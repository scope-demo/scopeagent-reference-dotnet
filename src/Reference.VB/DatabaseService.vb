...
Public Class DatabaseService
    ...
    Public Async Function IPersistentData_EnsureMigrationAsync() As Task Implements IPersistentData.EnsureMigrationAsync
        Using context = New GeoContext()
            Await context.Database.MigrateAsync()
        End Using
    End Function
    
    Public Async Function IPersistentData_SaveDataAsync(geoPoint As GeoPoint, item As OpenStreetMapItem) As Task(Of Boolean) Implements IPersistentData.SaveDataAsync
        Using context = New GeoContext()
    ...
    Public Async Function IPersistentData_GetAllAsync() As Task(Of List(Of (GeoPoint as GeoPoint, StreetMap as OpenStreetMapItem))) Implements IPersistentData.GetAllAsync
